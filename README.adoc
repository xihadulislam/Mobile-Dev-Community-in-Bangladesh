...
|Android, Flutter, Java, Kotlin, REST API, MVVM, Coroutine, Live Data, Dagger Hilt, Push Notification, Unit Testing, Retrofit2, Database [ Firebase , Room, SQLite ], Git Version Control.
|xihad.bd@gmail.com
