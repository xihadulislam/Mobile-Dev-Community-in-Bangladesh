...
|Android, Flutter, Java, Kotlin, MVVM, SDUI, Push Notification, Unit Testing, Widget Testing, REST API, Retrofit2, Database [ Firebase , Room, SQLite ], PHP, Laravel, MySql, Git Version Control. 
