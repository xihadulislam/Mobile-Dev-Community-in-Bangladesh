...
|Android, Flutter, Java, Kotlin, REST API, MVVM, Coroutine, Dagger hilt, Unit Test, Push Notification, Retrofit2, Database [ Firebase , Room, SQLite ], Git Version Control.
|xihad.bd@gmail.com
