...
|Android, Flutter, Java, Kotlin, REST API, MVVM, Coroutine, Dagger Hilt, Push Notification, Unit Test, Retrofit2, Database [ Firebase , Room, SQLite ], Git Version Control.
|xihad.bd@gmail.com
